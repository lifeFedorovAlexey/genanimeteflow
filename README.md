...
The model workers, Blender and motion assets must be installed and version-pinned before their stages can be enabled. No generated mesh or animation is bundled or represented as a fake result.
