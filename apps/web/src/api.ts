...
export interface Job { job_id: string; status: string; profile: string; resolution: number; references: Record<string, ReferenceSlot>; stages: Record<string, StageRecord>; updated_at: string; }
